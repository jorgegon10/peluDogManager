...
if (isset($_GET['nombre_usuario'])) {
    $empleadoNomUsu = $_GET['nombre_usuario']; // Obtener el nombre del usuario desde el GET
    echo "El nombre de usuario es: " . htmlspecialchars($empleadoNomUsu);
} else {
...
$empleado = $usuarioController->getUserByName2($empleadoNomUsu);
    ...
    <div class="main-container">
        <div class="detalleProducto">
            <div class="imagenProducto">
                <img src="<?= htmlspecialchars($empleado['imagen']) ?>" alt="Imagen del producto" >
                    ...
                    <input type="hidden" name="formUpdate" value="formulario">
                        ...
                        <div style="display: flex; gap:5%">
                            <div>
                                ...
                                value="<?= htmlspecialchars($empleado['nombre']) ?>" readonly>
                            </div>
                           <div>
                                <label for="1apellido" >1º Apellido:</label>
                                <input type="text" id="raza" name="raza"  class="form-control mb-3" 
                                value="<?= htmlspecialchars($empleado['apellido1']) ?>" readonly>
                           </div>
                        ...
                        <div style="display: flex; gap:5%">
                            <div>
                                <label for="precio">Puesto:</label>
                                <input type="text" id="precio" name="precio"  class="form-control mb-3" 
                                value="<?= htmlspecialchars($empleado['puesto']) ?>" readonly>
                            </div>
                            <div>
